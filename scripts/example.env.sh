...
#
# Local environmental config for Craft scripts
# @copyright Copyright (c) 2017 nystudio10
...
LOCAL_BACKUPS_PATH=${LOCAL_ROOT_PATH}"storage/backups/"

# -- REMOTE settings --

# Remote ssh credentials, user@domain.com and Remote SSH Port
REMOTE_SSH_LOGIN="REPLACE_ME@web1.amasci.uk"
REMOTE_SSH_PORT="22"
...
REMOTE_ROOT_PATH="/home/REPLACE_ME/public_html/"
#REMOTE_ROOT_PATH="/home/REPLACE_ME/dev/"
...
REMOTE_BACKUPS_PATH=${REMOTE_ROOT_PATH}"storage/backups/"
